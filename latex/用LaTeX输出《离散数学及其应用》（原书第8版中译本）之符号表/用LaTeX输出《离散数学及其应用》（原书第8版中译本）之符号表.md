...
### 三、pdf内容
![《离散数学及其应用》符号表](example1.png)

### 四、说明
- 我们可以看到，在布尔代数一栏中，表现非门、与门、或门时使用了tikz来绘制，虽然代码并不长，但我还是觉得麻烦，以后有时间想办法用其他方式来简洁地表示吧。
- 在使用XeTeX引擎的情况下，代码中的希腊字母只能在数学环境下表示，其他引擎就未必需要。