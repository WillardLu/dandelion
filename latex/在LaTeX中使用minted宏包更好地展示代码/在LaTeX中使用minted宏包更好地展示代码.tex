...
\begin{document}
\section{示例一}
代码 \mintinline[fontsize=\footnotesize]{cmake}{message(STATUS "[LIBRARY] Adding modules from ${LIBRARY_NAME}")} 展示


\section{示例二}
\begin{minted}[linenos=true,frame=single,breaklines,fontsize=\footnotesize]{c++}
//
...
\inputminted[linenos=true,frame=single,breaklines,fontsize=\footnotesize]{python}{postprocess_functions.py}
